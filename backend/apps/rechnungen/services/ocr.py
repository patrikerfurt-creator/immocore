...
- betrag_haushaltsnah: Lohn-/Arbeitskostenanteil gem. §35a EStG
  ("Lohnanteil", "Arbeitskosten", "Lohnkosten"). Diese Angabe steht oft
  NICHT bei den Kopfdaten, sondern als eigene kleine Tabelle/Zeile
  unterhalb der Summen oder des MwSt.-Nachweises — auch auf einer
  Folgeseite eines mehrseitigen Dokuments. Prüfe ALLE Seiten, besonders
  den Bereich nach dem Bruttoendbetrag. WICHTIG: Melde immer den
  Bruttobetrag (inkl. MwSt), so wie er als Lohnkosten-Betrag genannt
  wird — berechne NICHT selbst einen Nettobetrag daraus. Beispiel: Steht
  "Im Endbetrag sind 322,79 € Lohnkosten enthalten, darin enthaltene
  Mehrwertsteuer 51,54 €", dann ist wert=322.79 (nicht 271.25). Wenn
  NICHT ausgewiesen: wert=null (nicht schätzen).
